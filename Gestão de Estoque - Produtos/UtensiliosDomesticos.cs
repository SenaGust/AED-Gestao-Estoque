...
namespace Gestão_de_Estoque___Produtos
{
    ...
    {
        #region Construtor
        public UtensiliosDomesticos(int id, string nome, double margem_lucro, double preco, double estoque_inicial, double min_estoque) : base(id, nome, margem_lucro, preco, estoque_inicial, min_estoque)
        {
            Imposto = 0.35;
        }
        #endregion
